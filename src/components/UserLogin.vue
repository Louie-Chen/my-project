...
<div class="my-5">
    <form class="form-signin" @submit.prevent="signin">
        ...
        <button class="btn btn-lg btn-indigo btn-block" type="submit">登入</button>
        <button class="btn btn-lg btn-indigo btn-block" type="submit" @click.prevent="signout">登出</button>
